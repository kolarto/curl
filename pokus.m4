...
dnl includes even ifsfasdfdasd no INCLUDES argument is given. This macro will run
dnl silently when invoked with three arguments. If the expansion would
dnl result in a set of doubldfe-quoted strings the returned expansion will
